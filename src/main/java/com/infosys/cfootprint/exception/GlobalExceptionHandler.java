package com.infosys.cfootprint.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleDataIntegrityViolation(DataIntegrityViolationException ex) {
        ...
        body.put("status", HttpStatus.BAD_REQUEST.value());
        body.put("error", "Bad Request");
        body.put("message", "Database constraint error occurred. Please try logging in again.");
        return new ResponseEntity<>(body, HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<Map<String, Object>> handleAllExceptions(Exception ex) {
        ...
        if (message == null || message.contains("proxy") || message.contains("Hibernate") || message.contains("SQL")) {
